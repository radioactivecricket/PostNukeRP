...
function ENT:IdleSounds()
	local soundNum = math.random(4)
	local SoundFile = nil
	
	SoundFile = "npc/crow/idle"..tostring(soundNum)..".wav"
...
function ENT:HDAlertSound()
	...
	SoundFile = "npc/crow/alert"..tostring(soundNum)..".wav"
...
function ENT:HDPainSounds()
	...
	SoundFile = "npc/crow/pain"..tostring(soundNum)..".wav"
...
function ENT:CommandSound()
	local soundNum = math.random(2,3)
	local SoundFile = nil
	
	SoundFile = "npc/crow/crow"..tostring(soundNum)..".wav"
