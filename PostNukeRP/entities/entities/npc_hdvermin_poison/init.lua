...
--	self.iNPCState = SCHED_IDLE_WANDER
	...
	self.Model = "models/headcrabblack.mdl"
	...
	self:SetNetVar("name", "Wild Headcrab")
...
function ENT:IdleSounds()
	...
	local SoundFile = nil
	local hdType = "headcrab_poison"
	
	SoundFile = "npc/"..hdType.."/ph_idle"..tostring(soundNum)..".wav"
...
function ENT:HDAlertSound()
	...
	SoundFile = "npc/"..hdType.."/ph_hiss1.wav"
...
function ENT:HDPainSounds()
	...
	SoundFile = "npc/"..hdType.."/ph_pain"..tostring(soundNum)..".wav"
