...
SWEP.Author		= "LostInTheWired/Postman"
...
function SWEP:SecondaryAttack()
	if self.Owner:KeyDown( IN_WALK ) then
		...
		if savedBool then
			...
			self.Weapon:SetNWFloat("MouseSensitivity", 0.1)
...
function SWEP:Deploy()
	...
	self.Weapon:SetNWBool("IsPassive", false)
	self.Weapon:SetNWFloat("MouseSensitivity", 0.01)
...
function SWEP:ShootBullet( damage, num_bullets, aimcone, recoil )
	...
	bullet.Force	= 8000	-- Amount of force to give to phys objects
