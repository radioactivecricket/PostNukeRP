...
SWEP.Purpose		= "A decently refurbished SAW, great for mid-range\n  support fire.  Definately a team player's weapon."
...
SWEP.IronSightsPos = Vector (-4.4768, 0, 2.1424)
...
function SWEP:Initialize()
	...
	util.PrecacheSound("Weapon_M249.Reload")
...
function SWEP:Reload()
	if self.Weapon:Clip1() < self.Primary.ClipSize then
		...
		self.Weapon:EmitSound("Weapon_M249.Reload")
