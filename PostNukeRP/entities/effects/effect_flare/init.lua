-- Based on mad cow scripts, I'm pretty sure.  Havn't worked
-- with effects before, so I started from a base.
...
function EFFECT:Render() 
	...
	local curFogMode = render.GetFogMode()
	render.FogMode( 0 )
