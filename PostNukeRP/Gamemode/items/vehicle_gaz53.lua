...
ITEM.Chemicals = 50
ITEM.Chance = 100
ITEM.Info = "A practical tank of the wastes."
ITEM.Type = "vehicle"
ITEM.Remove = true
ITEM.HP = 300
ITEM.Energy = 0
ITEM.Ent = "prop_vehicle_jeep"
ITEM.EntName = "truck003a_01"
ITEM.Model = "models/source_vehicles/truck003a_01.mdl"
ITEM.Script = "scripts/vehicles/truck003a_01.txt"
ITEM.Hull = "models/props_vehicles/truck003a.mdl"
ITEM.SeatLoc = {{Pos = Vector(23,0,42), Ang = Angle(0,0,8)}}
