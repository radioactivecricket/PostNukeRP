...
ITEM.ID = "vehicle_utility"

ITEM.Name = "The Utility"
ITEM.ClassSpawn = "None"
ITEM.Scrap = 275
ITEM.Small_Parts = 150
ITEM.Chemicals = 50	
ITEM.Chance = 100
ITEM.Info = "At least you're equipped."
ITEM.Type = "vehicle"
ITEM.Remove = true
ITEM.HP = 100
ITEM.Energy = 0
ITEM.Ent = "prop_vehicle_jeep"
ITEM.EntName = "car003b"
ITEM.Model = "models/source_vehicles/car003b/vehicle.mdl"
ITEM.Script = "scripts/vehicles/rubbishcar.txt"
ITEM.Hull = "models/props_vehicles/car003b_physics.mdl"
ITEM.SeatLoc = {{Pos = Vector(17,-5,15), Ang = Angle(0,0,8)},
				{Pos = Vector(16,-40,15), Ang = Angle(0,0,8)},
				{Pos = Vector(-16,-40,15), Ang = Angle(0,0,8)}}
