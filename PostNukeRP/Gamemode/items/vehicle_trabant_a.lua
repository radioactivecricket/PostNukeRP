...
ITEM.Chemicals = 50	
ITEM.Chance = 100
ITEM.Info = "A decent full sized coupe. Great for hauling!"
ITEM.Type = "vehicle"
ITEM.Remove = true
ITEM.HP = 125
ITEM.Energy = 0
ITEM.Ent = "prop_vehicle_jeep"
ITEM.EntName = "car002a"
ITEM.Model = "models/source_vehicles/car002a.mdl"
ITEM.Script = "scripts/vehicles/hl2_hatchback.txt"
ITEM.Hull = "models/props_vehicles/car002a_physics.mdl"
ITEM.SeatLoc = {{Pos = Vector(16,-5,11), Ang = Angle(0,0,8)}}
